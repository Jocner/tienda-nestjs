...
__decorate([
    (0, typeorm_1.OneToMany)(() => TransactionContents, (transaction) => transaction.transaction),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => product_entity_1.Product, (product) => product.id, { eager: true, cascade: true }),
    __metadata("design:type", product_entity_1.Product)
], TransactionContents.prototype, "product", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Transaction, (transaction) => transaction.contents, { cascade: true }),
